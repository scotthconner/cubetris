 ...
 */
public class ElasticTweenFunction implements ITweenFunction {
    private static ElasticTweenFunction mInstance = null;
    private ElasticTweenFunction() { }
    public static ElasticTweenFunction getInstance() {
        if (null == mInstance) {
            mInstance = new ElasticTweenFunction();
        }
        return mInstance;
    }
